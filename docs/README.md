...
## 기능 목록
- [ ] 이동 전략
  - [ ] 0에서 9사이의 random 값을 구한 후 4 이상의 값이면 전진
- [ ] 자동차
  - [ ] 이름
    - [ ] 1자 이상 5자 이하만 가능
  - [ ] 위치
    - [ ] 이동 전략에 따라 위치 변경
- [ ] n대의 자동차
  - [ ] 쉼표(,)를 기준으로 구분해서 2대 이상의 자동차 생성
  - [ ] 동일한 자동차 이름은 생성 불가
  - [ ] 전체 자동차가 1회 경주해서 자동차 이름, 위치 기록 생성
  - [ ] 위치가 가장 큰 자동차로 우승자 판정, 공동 우승 가능
- [ ] 이동(경주) 횟수
  - [ ] 숫자 1 ~ Integer.MAX_VALUE 사이만 가능
- [ ] 경주
  - [ ] n대의 자동차가 n회 경주해서 기록 생성
- [ ] 기록
  - 차수별 자동차 이름, 위치와 우승자
- [ ] 사용자 입력
  - [ ] 자동차 이름 입력
